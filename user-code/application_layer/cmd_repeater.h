...
#ifndef _APP_CMD_REPEATER_
#define _APP_CMD_REPEATER_
...
extern int command_callback_repeater( char *command_output, int output_buf_len, const char *command_string );
